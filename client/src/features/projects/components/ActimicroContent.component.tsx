    ...
    <>
        ...
        <div className="flex flex-col items-center gap-2 my-8">
          <div className="w-80 rounded-xl overflow-hidden border border-slate-700 bg-brand-surface">
            <img
              ...
              alt={t("actimicro.page.heroImageAlt")}
              className="w-full object-cover"
            />
          </div>
          <p className="text-xs text-slate-500">{t("actimicro.page.heroCaption")}</p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <div className="border-t border-brand-surface pt-16">
          <h2 className="text-2xl font-semibold mb-2">{t("actimicro.page.section2Title")}</h2>
          <p className="text-slate-400 text-sm leading-relaxed mb-4 max-w-xl">
            {t("actimicro.page.section2Text")}
          </p>
          ...
          <div className="rounded-xl overflow-hidden border border-slate-700 bg-brand-surface">
            <img
              ...
              alt={t("actimicro.page.section2ImageAlt")}
              className="w-full object-cover"
            />
          </div>
          <p className="text-xs text-slate-500 mt-3 text-center">
            {t("actimicro.page.section2Caption")}
          </p>
        </div>
      </section>
    </>
